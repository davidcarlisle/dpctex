...
Der \emph{rowcolors status} ist standardmäßig aktiviert (d.h. Farbschema verwenden) und/oder \verb"\showrowcolors", er wird durch den Befehl \verb"\hiderowcolors" deaktiviert (d.h. Farbschema ignorieren).
