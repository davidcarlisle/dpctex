...
%
%% ltxtable package (C) 1995, 2001 David Carlisle
%%
%% This file may be distributed under the terms of the LPPL.
%% See 00readme.txt for details.
%
...
\ProvidesPackage{ltxtable}
                [2001/06/12 v0.3 longtable/tabularx merge (DPC)]
%    \end{macrocode}
% 
...
\def\endlongtable{%
  \LT@echunk
% from 2001 longtable uses an allocated box \LT@gbox not \box1
